   ...
   @subpage-title{Seminars}
    ...
    <div class="pn-main-wrapper">
      <div class="content">
        <div class="container">
          <div class="row">
            <p>For NEU students and staff, the mailing lists <strong>prl-students</strong> and <strong>prl-staff</strong> are maintained by <a href= "mailto:j.vitek@"@"neu.edu">Jan Vitek</a>.</p>
          </div>
        </div>
