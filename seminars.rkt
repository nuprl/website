...
@(define seminars
   (splice
    ...
    (seminar
     ...
     (datetime 2018 4 24 11 45)
     "WVH 366"
     @list{@p{I will present Call-by-name (CBN) Gradual Type Theory [1], an
