          ...
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              ...
              <ol>
                ...
                <li>Coordinate with the lab member in charge of <a href="people.html">the people page</a> (<a href="mailto:maxnew@"@"ccs.neu.edu">Max New</a> as of January 2016) to add your picture and bio, as well as to add yourself to the <strong>prl-students</strong> or <strong>prl-staff</strong> mailing list, as appropriate.</li>
                ...
                <li>No need to sign up immediately, but if you need a private place to store code, there is both a <a href="https://github.ccs.neu.edu/">CCIS-managed GitHub instance</a> as well as our lab's <a href="https://github.com/nuprl">nuprl organization</a> on GitHub. To get access to the nuprl organization, ask the owner (Jon Schuster as of September 2016) to add you as a member.
