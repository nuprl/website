...
To create a new post:
   ...
   1. Clone the [nuprl.github.io](https://github.com/nuprl/nuprl.github.io) repository
   2. Check out a new branch for your post
   3. Run `cd blog; raco frog -n "TITLE"` to build a template for a new post
   4. Add content to the new markdown file
   5. Rebuild the blog with `raco frog -b`, view your changes at `index.html`
   6. Post a pull request to the github repo
...
Visitors are always welcome the the PRL.
