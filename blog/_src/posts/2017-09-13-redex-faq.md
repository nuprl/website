...
See [the Redex reference](http://docs.racket-lang.org/redex/The_Redex_Reference.html) for the full pattern language.
...
- Non-regular patterns, e.g., a sequence of numbers followed by an _equal number_
  of symbols.
